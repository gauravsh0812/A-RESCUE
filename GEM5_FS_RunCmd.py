# NOTE: Kindly change the paths as your system.
...
'''
./build/ARM/gem5.opt --stats-file=360buy.rcs_75M_100G.txt configs/example/fs.py --caches --l1i_size=32kB --l1i_assoc=4 --l1d_size=32kB --l1d_assoc=4 --cacheline_size=64 --cpu-clock=2GHz --mem-size=256MB --cpu-type=O3_ARM_v7a_3 --l1d_ret=50M --l1i_ret=1G --maxinsts=1000000000 --script=/home/gauravs/Kyle_gem5/gem5_tlb/asimbench/boot/360buy.rcs --disk-image=ARMv7a-ICS-Android.SMP.Asimbench-v3.img --machine-type=RealView_PBX --os-type=android-ics -F 5000000000
